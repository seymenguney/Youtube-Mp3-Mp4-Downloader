...
namespace Youtube_MP3_MP4_Download
{
    public partial class Form1 : Form
    {
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            using (FolderBrowserDialog fbd = new FolderBrowserDialog() { Description = "Please Select Folder" })
            {
                if (fbd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    var inputfile = new MediaToolkit.Model.MediaFile { Filename = fbd.SelectedPath + @"\" + video.FullName }; //Input
                    var outputfile = new MediaToolkit.Model.MediaFile { Filename = $"{fbd.SelectedPath + @"\" + video.FullName }.mp3" }; //Output
        ...
        private void radioButton1_CheckedChanged(object sender, EventArgs e) // Mp3
        {
            format = true;
        }

        private void radioButton2_CheckedChanged(object sender, EventArgs e) // Mp4
        {
            format = false;
        }
        ...
        void GetTitle()
        {
            ...
            StreamReader sr = new StreamReader(reply.GetResponseStream());  // Video Url: --> Video Name
        ...
        private void progressBar1_Click(object sender, EventArgs e) //Download Animation
        {
